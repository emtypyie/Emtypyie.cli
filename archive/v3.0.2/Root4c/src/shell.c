...
/* Shell startup banner: classic figlet "emtypyie" art + version/tagline (no bread). */
...
void shell_run(void) {
    ...
    if (!piped) {
        ...
        printf("  %s\n", retro_accent("EMTYPYIE CLI v3.0.2"));
