...
// __dirname = .../archive/v3.0.4/Root4node/commands
// Need to go up: commands -> Root4node -> v3.0.4 -> archive -> Emtypyie.cli -> dev-cdn (5 levels up to Emtypyie.cli, then dev-cdn)
